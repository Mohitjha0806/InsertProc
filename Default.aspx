         ...
         <div class="container bg-light-subtle py-5">
             ...
             <div class="row mt-2">
                 <div class="col-md-6">
                     ...
                     <asp:RadioButtonList ID="rbl_Gender" CssClass="form-control border-3 fw-semibold border-dark-subtle gap-2 bg-info-subtle " RepeatDirection="Horizontal" runat="server">
                         <asp:ListItem CssClass="form-control mx-2" Text=" Male" />
                         <asp:ListItem CssClass="form-control" Text=" Female" />
                     </asp:RadioButtonList>
             ...
             <div class="row mt-3 py-4">
                 <div class="col-md-3">
                     <asp:Button Text="Submit" ID="btn_Submit" CssClass="btn btn-primary fw-semibold" runat="server" OnClick="btn_Submit_Click" AutoPostBack="true" />
                     <asp:Button Text="Reset" ID="Btn_Reset" CssClass="btn btn-danger fw-semibold fw-semibold" runat="server" />
                 </div>
             </div>
         </div>
         <div class="contaoner row">
             <asp:GridView runat="server" ID="gb_UserDetail" OnRowCommand="gb_UserDetail_RowCommand">
                 <Columns>
                     <asp:TemplateField HeaderText="First Name">
                         <ItemTemplate>
                             <asp:Label Text='<%#Eval("FIRST_NAME") %>' ID="lbl" runat="server" />
                         </ItemTemplate>
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="First Name">
                         <ItemTemplate>
